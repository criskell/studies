...
/* package myapp-0.1.0.0 */
#ifndef VERSION_myapp
#define VERSION_myapp "0.1.0.0"
#endif /* VERSION_myapp */
#ifndef MIN_VERSION_myapp
#define MIN_VERSION_myapp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_myapp */
...
#define CURRENT_COMPONENT_ID "myapp-0.1.0.0-inplace-myapp"
